...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/hosseinpv1379/s-ui/master/install.sh)
```
...
```sh
VERSION=1.0.0 && bash <(curl -Ls https://raw.githubusercontent.com/hosseinpv1379/s-ui/$VERSION/install.sh) $VERSION
```
